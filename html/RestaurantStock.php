...
<html>
  ...
  <body>
    ...
    <div id="main">
      <h4> RESTAURANT STOCK</h4>
      <div class="container">
        <!--main paragraph element that contains the table content built through javascript-->
       <!--<p id="tableMain"></p>-->
       <div class="tableStock" id="tableMain"></div>
        <script type="text/javascript" src="/Cluk/js/RestaurantStock.js"></script>
      </div>
    </div>
...
<!--Styling for the current stock table-->
<style>
  table {
