<?php
	/*
		Checks for POS if the quantity is enough for the meal item.
	*/
	...
	while($stmt->fetch()){
		$query2 = "SELECT quantity FROM cluk_restaurant_stocks_ingredients WHERE restaurant_id = ? AND ingredient_id = ?;";
