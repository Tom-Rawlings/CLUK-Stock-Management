...
function getStock(){
  $.ajax({
    type: "POST",
    url:"/Cluk/php/queries/getStockForWarehouse.php",
    data: {},
    dataType: "json",
    success: function(rows){
     // var textToDisplay = '<p class="d-inline-block" id="stockTable"> Warehouse Stock<br/><br/>';
    var  textToDisplay = '<table class="table table-sm table-striped"><thead class="thead-dark"><tr><th>Id</th><th>Ingredient</th><th>Quantity</th><th>Category</th></tr></thead>';
      ...
      $.each(rows, function(key, row){
          ...
          '<input class="Stockbutton-E" type="button" id="editButton'+row.ingredient_id+'" value="Edit" onClick="makeEditable('+row.ingredient_id+')"></td></tr>';
    ...
    error: function(){
      alert(queryErrorText + "(getStockForWarehouse)");
    }
  });
...
function updateIngredientStock(lineNumber){
  ...
  console.log("ingredient_id = "+ingredient_id+"\nquantity = " + quantity)
    $.ajax({
    type: "POST",
    url:"/Cluk/php/queries/setIngredientStockLevelWarehouse.php",
    ...
    error: function(){
      alert(queryErrorText + "(setIngredientStockLevelWarehouse)");
    }
  });
}
...
function revertLine(lineNumber){
  ...
  $.ajax({
    type: "POST",
    url:"/Cluk/php/queries/getIngredientStockLevelWarehouse.php",
    data: {ingredient_id},
    dataType: "json",
    success: function(rows){
      var textToDisplay = '';
    ...
    error: function(){
      alert(queryErrorText + "(getIngredientStockLevelWarehouse)");
    }
  });
